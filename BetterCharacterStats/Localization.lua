...
BCS["L"] = {
	...
	["Если на персонаже: Improves your chance to hit by (%d)%%."] = "Если на персонаже: Improves your chance to hit by (%d)%%.",
	...
	["Если на персонаже: Improves your chance to get a critical strike with spells by (%d)%%."] = "Если на персонаже: Improves your chance to get a critical strike with spells by (%d)%%.",
	["Если на персонаже: Improves your chance to hit with spells by (%d)%%."] = "Если на персонаже: Improves your chance to hit with spells by (%d)%%.",
