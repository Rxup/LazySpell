...
HB_BONUSSCANNER_PREFIX_EQUIP = "На персонаже: ";
HB_BONUSSCANNER_PREFIX_SET = "Комплект: ";
...
HB_SPELL_PATTERN_LESSER_HEAL         = "Heal your target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_HEAL                = "Heal your target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_GREATER_HEAL        = "A slow casting spell that heals a single target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_FLASH_HEAL          = "Heals a friendly target for (%d+) [^%s]+ (%d+).";
HB_SPELL_PATTERN_RENEW               = "Heals the target of (%d+) [^%s]+ (%d+) damage over (%d+) сек";
HB_SPELL_PATTERN_RENEW1              = "Heals the target of (%d+) damage over (%d+) сек";
HB_SPELL_PATTERN_RENEW2              = "Not needed for en";
HB_SPELL_PATTERN_RENEW3              = "Not needed for en";
HB_SPELL_PATTERN_SHIELD              = "absorbing (%d+) damage.  Lasts (%d+) сек.";
HB_SPELL_PATTERN_HEALING_TOUCH       = "Heals a friendly target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_REGROWTH            = "Heals a friendly target for (%d+) [^%s]+ (%d+) and another (%d+) over (%d+) сек.";
HB_SPELL_PATTERN_REGROWTH1           = "Heals a friendly target for (%d+) [^%s]+ (%d+) and another (%d+) to (%d+) over (%d+) сек.";
HB_SPELL_PATTERN_HOLY_LIGHT          = "Heals a friendly target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_FLASH_OF_LIGHT      = "Heals a friendly target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_HEALING_WAVE        = "Heals a friendly target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_LESSER_HEALING_WAVE = "Heals a friendly target for (%d+) [^%s]+ (%d+)";
HB_SPELL_PATTERN_REJUVENATION        = "Heals the target for (%d+) over (%d+) сек.";
HB_SPELL_PATTERN_REJUVENATION1       = "Heals the target for (%d+) [^%s]+ (%d+) over (%d+) сек.";
HB_SPELL_PATTERN_MEND_PET            = "Heals your pet (%d+) health every second while you focus.  Lasts (%d+) сек.";

HB_TOOLTIP_MANA                    = "^Мана: (%d+)$";
HB_TOOLTIP_RANGE                   = "Радиус действия: (%d+)";
HB_TOOLTIP_INSTANT_CAST            = "Мгновенное действие";
HB_TOOLTIP_CAST_TIME               = "Применение: (%d+.?%d*)";
